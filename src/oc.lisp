...
(cffi:defcfun ("_wrap_delete_MMgt_TShared" _wrap_delete_MMgt_TShared) :void
  (self :pointer))
...
(cffi:defcfun ("_wrap_delete_Geom2d_Point" _wrap_delete_Geom2d_Point) :void
  (self :pointer))
...
(cffi:defcfun ("_wrap_delete_Geom2d_CartesianPoint" _wrap_delete_Geom2d_CartesianPoint) :void
  (self :pointer))
