...
(defmethod mirrored ((geometry geom2d-geometry) (a ax2d))
...
(defmethod rotated ((geometry geom2d-geometry) (p pnt2d) (ang number))
  (let ((pointer
...
(defmethod scaled ((geometry geom2d-geometry) (p pnt2d) (s number))
  (let ((pointer
...
(defmethod translated ((geometry geom2d-geometry) (v vec2d))
  (let ((pointer (_wrap_Geom2d_Geometry_Translated__SWIG_0 (ff-pointer geometry) (ptr v)))
	(instance (allocate-instance (class-of geometry))))
    (setf (ff-pointer instance) pointer)
    instance))

(defmethod translated2 ((geometry geom2d-geometry) (p1 pnt2d) (p2 pnt2d))
  (let ((pointer
