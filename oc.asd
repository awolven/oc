(defsystem oc
  ...
  ((:file "lib/foreign-libraries")
   ...
   (:file "src/geom2d/geom2d-vector")
   (:file "src/geom2d/geom2d-vector-with-magnitude")
   (:file "src/geom2d/geom2d-direction")
   (:file "src/geom2d/geom2d-axis-placement")
   ...
   (:file "src/geom2d/geom2d-hyperbola")
   (:file "src/geom2d/geom2d-parabola")
   ...
   (:file "src/geom2d/geom2d-offset-curve")
   ...
   (:file "src/poly/poly-polygon-on-triangulation")
